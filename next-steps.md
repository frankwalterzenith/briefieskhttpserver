...
1. Modify or add environment variables to configure the running application. Environment variables can be configured by modifying the `env` node in the following files:
    - [app/KernelHttpServer.bicep](./infra/app/KernelHttpServer.bicep)
...
- [app/KernelHttpServer.bicep](./infra/app/KernelHttpServer.bicep) - Azure Container Apps resources to host the 'KernelHttpServer' service.
